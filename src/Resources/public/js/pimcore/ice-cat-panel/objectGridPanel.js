...
pimcore.registerNS("pimcore.plugin.iceCatObjectGridPanel.js");
pimcore.plugin.iceCatObjectGridPanel  = Class.create(pimcore.object.abstract, {
initialize: function(id) {
    ...
    forgetOpenTab: function() {
        pimcore.globalmanager.remove("objectss_" + this.id);
        pimcore.globalmanager.remove("objectss_toolbar_" + this.id);
        pimcore.helpers.forgetOpenTab("objectss_" + this.id + "_folder");
    },
    ...
    save : function (task) {
        ...
        Ext.Ajax.request({
            url: Routing.generate('pimcore_admin_dataobjectss_dataobjectss_savefolder', {task: task}),
            method: "PUT",
